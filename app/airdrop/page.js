    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-20">
      ...
      <div className="flex-col z-10 w-full max-w-5xl items-center justify-center font-mono text-lg lg:flex">
          ...
          <br/><br/>
            ...
            <h2><b>When?</b></h2>
           The airdrop will start on June 28th, 2024. The claim window will be open for 1 week.
           <br/><br/>
           <h2><b>How?</b></h2>
           General conditions:
            <ul>
        ...
        <div style={{
          ...
          <h2><b>Tokenomics?</b></h2>
           ...
           The airdrop will start on June 28th, 2024. The claim window will be open for 1 week. We already told you that.
